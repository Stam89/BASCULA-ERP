...
import { guiasRouter } from "./modules/guias.js";
...
import { adminPayrollRouter } from "./modules/admin-payroll.js";
...
routes.use("/guias-remision", guiasRouter);
...
routes.use("/admin-payroll", adminPayrollRouter);
